...
######################################## MOTION LIST STUFF##########################
        ...
        self.eb.setToolTip("Enter the number of data points you wish to define.\n Enter multiple integers separated by commas (i.e '1,2,3') for disjoint regions")
        ...
        self.ec.setToolTip("Enter the number of data points you wish to define.\n Enter multiple integers separated by commas (i.e '1,2,3') for disjoint regions")
...
##################################################################################
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CountPerStepLabel.setText(_translate("MainWindow", "Enter Encoder-Motor Counts/Step:"))
        self.StepPerRevLabel.setText(_translate("MainWindow", "Enter Steps/Revolution: "))
        self.SelectThreadingLabel.setText(_translate("MainWindow", "Select Rod Threading:"))
        self.IsCustomLabel.setText(_translate("MainWindow", "If custom, please specify (cm/rev)-"))
        ...
        self.ConfigGroupLabel.setText(_translate("MainWindow", "CONFIGURE NEW MOTION GROUP:"))
        ...
        self.gridCentre.setToolTip(_translate("MainWindow", "Enter custom-center(s) in the format (x,y,z), (x1,y1,z1,) , or leave empty for default gridding (Centers of defined regions). Must specify centers for auto-shape generation."))
        ...
        self.pointnumberLabel.setText(_translate("MainWindow", "Number of points defined: 0"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.GD), _translate("MainWindow", "Motion Group Configuration"))
